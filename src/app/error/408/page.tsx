            ...
            <Col xxl={5} md={6} sm={8}>
              <Card className="p-4">
                ...
                <div className="p-4 text-center">
                  ...
                  <h3 className="fw-bold text-uppercase">Connection Timed Out</h3>
                  <p className="text-muted fs-5">The request took too long to respond. Please check your connection and try again.</p>
                  <div className="mt-4 d-flex justify-content-center gap-1">
                    <Link href="/" className="btn btn-primary">
                      Try Again
                    </Link>
                    <button className="btn btn-outline-info">Get Help</button>
                  </div>
                </div>
              </Card>
