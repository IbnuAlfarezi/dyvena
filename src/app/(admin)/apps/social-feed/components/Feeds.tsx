    ...
    <Card>
      <CardBody className="pb-2">
        <div className="d-flex align-items-center mb-2">
          <Image height={32} width={32} className="me-2 avatar-md rounded-circle" src={image} alt="Generic placeholder image" />
          <div className="w-100">
            <h5 className="m-0">
        ...
        <div className="mt-2">
          ...
          <span className="btn btn-sm fs-sm btn-link text-muted" data-toggler="on">
            <span data-toggler-on className="align-middle">
              <Icon icon="heart-filled" className="text-danger" /> Liked!
            </span>
            <span data-toggler-off className="d-none align-middle">
              <Icon icon="heart-filled" className="text-muted" /> Like
            </span>
          </span>
          <Link href="" className="btn btn-sm fs-sm btn-link text-muted">
      ...
      <div className="bg-light-subtle mx-n3 p-3 border-top border-bottom border-dashed">
        {commentData.map((comment, idx) => (
          <div className={clsx('d-flex align-items-start', { 'mb-2': commentData.length > 1 })} key={idx}>
            <Image className="me-2 avatar-sm rounded-circle" src={comment.image} alt="Generic placeholder image" />
            <div className="w-100">
                    ...
                    <Fragment key={idx}>
                      <div className="d-flex align-items-start mt-3">
                        <Link className="pe-2" href="">
                          <Image src={reply.image} className="avatar-sm rounded-circle" alt="Generic placeholder image" />
                        </Link>
                        <div className="w-100">
                          <h5 className="mt-0 mb-1">
                            <Link href="/apps/users/profile" className="link-reset">
