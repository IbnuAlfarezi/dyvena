...
export type TaskType = {
  ...
  assignee: { name: string; members: number; image: StaticImageData }
  dueDate: string
  totalTask: number
  completedTask: number
  status: 'in-progress' | 'new' | 'cancelled' | 'in-review' | 'completed'
...
export const taskData: TaskType[] = [
  {
    ...
    assignee: { name: 'Cruise ⚒️', members: 2, image: user2 },
    dueDate: 'Today',
    totalTask: 7,
    completedTask: 0,
    status: 'new',
  ...
  },
  {
    ...
    assignee: { name: 'Maria 💻', members: 2, image: user5 },
    dueDate: '29 Oct, 2025',
    totalTask: 10,
    completedTask: 5,
    status: 'in-progress',
  ...
  },
  {
    ...
    assignee: { name: 'Kevin', members: 1, image: user3 },
    dueDate: '29 Oct, 2025',
    totalTask: 8,
    completedTask: 6,
    status: 'in-progress',
  ...
  },
  {
    ...
    assignee: { name: 'Thomas 🏠', members: 1, image: user4 },
    dueDate: '20 Sep, 2025',
    totalTask: 5,
    completedTask: 2,
    status: 'in-progress',
  ...
  },
  {
    ...
    assignee: { name: 'James', members: 1, image: user6 },
    dueDate: 'Yesterday',
    totalTask: 4,
    completedTask: 4,
    status: 'completed',
  ...
  },
  {
    ...
    assignee: { name: 'Sophia 🚀', members: 3, image: user7 },
    dueDate: '22 Oct, 2025',
    totalTask: 6,
    completedTask: 1,
    status: 'new',
  ...
  },
  {
    ...
    assignee: { name: 'Liam', members: 1, image: user8 },
    dueDate: '19 Sep, 2025',
    totalTask: 8,
    completedTask: 7,
    status: 'cancelled',
  ...
  },
  {
    ...
    assignee: { name: 'Olivia', members: 2, image: user9 },
    dueDate: 'Tomorrow',
    totalTask: 10,
    completedTask: 3,
    status: 'new',
  ...
  },
  {
    ...
    assignee: { name: 'Ethan', members: 1, image: user10 },
    dueDate: '12 Nov, 2025',
    totalTask: 8,
    completedTask: 1,
    status: 'in-progress',
  ...
  },
  {
    ...
    assignee: { name: 'Charlotte', members: 1, image: user4 },
    dueDate: 'Next Week',
    totalTask: 12,
    completedTask: 2,
    status: 'in-progress',
  ...
  },
  {
    ...
    assignee: { name: 'Grace', members: 1, image: user2 },
    dueDate: '12 Sep, 2025',
    totalTask: 10,
    completedTask: 9,
    status: 'cancelled',
  ...
  },
  {
    ...
    assignee: { name: 'Noah', members: 1, image: user6 },
    dueDate: '18 Oct, 2025',
    totalTask: 7,
    completedTask: 2,
    status: 'in-progress',
