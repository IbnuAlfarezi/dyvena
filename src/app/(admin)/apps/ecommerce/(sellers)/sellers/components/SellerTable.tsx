      ...
      cell: ({ row }) => (
        <div className="d-flex align-items-center">
          <div className="avatar-md me-3">
            <Image src={row.original.seller.image} alt="Product" className="img-fluid rounded" />
          </div>
          <div>
            <h5 className="mb-1">
    ...
    columnHelper.accessor('country', {
      ...
      cell: ({ row }) => (
        <span className="badge p-1 text-bg-light fs-sm">
          <Image src={row.original.country.flag} alt="flag" className="rounded-circle me-1" height={12} /> {row.original.country.code}
        </span>
      ),
    }),
