...
export type StaffType = {
  ...
  role: string
  department: string
  status: 'active' | 'on-leave' | 'suspended' | 'probation' | 'review-pending'
}

export const staffListData: StaffType[] = [
  {
    id: 'STF-001',
    member: {
      image: user3,
