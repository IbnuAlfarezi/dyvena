...
import { saleReportData } from './data'
        ...
        <TabContainer defaultActiveKey="monthly">
          ...
          <CardBody className="p-0">
            ...
            <div className="p-3 pt-1">
              ...
              <ApexChart getOptions={getSalesReportChart} series={getSalesReportChart().series} type="line" height={342} />
            </div>
          </CardBody>
        </TabContainer>
      </Card>
