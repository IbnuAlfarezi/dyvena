...
export const financeStatData: FinanceStatType[] = [
  {
...
export const transactionData: TransactionType[] = [
  {
    id: '#TX901',
    user: { name: 'Sophia Miller', image: user5 },
  ...
  {
    id: '#TX900',
    user: { name: 'James Carter', image: user2 },
  ...
  {
    id: '#TX898',
    user: { name: 'Liam Thompson', image: user3 },
  ...
  {
    id: '#TX897',
    user: { name: 'Emma Stone', image: user4 },
  ...
  {
    id: '#TX895',
    user: { name: 'Olivia Brown', image: user8 },
  ...
  {
    id: '#TX894',
    user: { name: 'David Chen', image: user1 },
  ...
  {
    id: '#TX893',
    user: { name: 'Marcus Lee', image: user6 },
  ...
  {
    id: '#TX891',
    user: { name: 'Henry Walker', image: user7 },
  ...
  {
    id: '#TX889',
    user: { name: 'Emily Frost', image: user3 },
