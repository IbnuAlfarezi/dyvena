                ...
                <div className="border-bottom border-dashed px-4 py-3" key={idx}>
                  ...
                  <p className="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                    <span className="d-flex align-items-center gap-1">
                      <Image src={item.user.image} height={24} width={24} alt="avatar-4" className="img-fluid avatar-xs rounded-circle" />
              ...
              <div className="border-bottom border-dashed px-4 py-3">
                ...
                <div className="d-flex gap-2">
                  <div className="avatar">
                    <Image src={user4} alt="" className="rounded avatar-xl" />
                  </div>
                  <div className="avatar">
                    <Image src={user5} alt="" className="rounded avatar-xl" />
                  </div>
                  <div className="avatar">
                    <Image src={user3} alt="" className="rounded avatar-xl" />
                  </div>
                  <div className="avatar">
                    <Image src={user8} alt="" className="rounded avatar-xl" />
                  </div>
                  <div className="avatar">
                    <Image src={user2} alt="" className="rounded avatar-xl" />
                  </div>
                </div>
              </div>
