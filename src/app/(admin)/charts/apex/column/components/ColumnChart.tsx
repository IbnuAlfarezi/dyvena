  ...
  const initializeCharts = () => {
    ...
    const yearChartOptions: ApexOptions = {
      ...
      dataLabels: {
        enabled: true,
        style: { colors: ['#fff'] },
        formatter: (_val, opt: any) => opt.w.globals.labels[opt.dataPointIndex],
        offsetX: 10,
    ...
    const quarterChartOptions: ApexOptions = {
      ...
      tooltip: {
        x: {
          formatter: (_val, opts: any) => opts.w.globals.seriesNames[opts.seriesIndex],
        },
        y: {
          title: {
            formatter: (_val, opts: any) => opts.w.globals.labels[opts.dataPointIndex],
          },
        },
      },
    }
